...
$(document).ready(function() {
    $('#helloworld')
        .append('<span>Assignment  </span>')
    
    d3.select('#helloworld')
        .append('span')
        .html('Name: Aniruddhan Murali');
    ...
    dropdownButton // Add a button
      ...
      dropdownButton.on("change", function(d) {
        ...
        if (selectedOption == "before 2000")
        {
          //processsData('data/jean-complete-node_2000.csv', 'data/jean-complete-edge_2000.csv')
        }
        else if (selectedOption == "before 2005")
        {
          //processsData('data/jean-complete-node_2005.csv', 'data/jean-complete-edge_2005.csv')
        }
        else if (selectedOption == "before 2010")
        {
          //processsData('data/jean-complete-node_2010.csv', 'data/jean-complete-edge_2010.csv')
        }
        else if (selectedOption == "before 2015")
        {
          //processsData('data/jean-complete-node_2015.csv', 'data/jean-complete-edge_2015.csv')
        }
        else if (selectedOption == "present")
        {
          //processsData('data/jean-complete-node.csv', 'data/jean-complete-edge.csv')
        }
